...
class ClipBLRectShapeBorder extends ShapeBorder {
  double clipRatio;
  double maxSize;
  double thickness;
  Color outlineColor;

  ClipBLRectShapeBorder({this.clipRatio = 0.1, this.maxSize = -1.0, this.thickness = 1.0, this.outlineColor = Colors.black});
